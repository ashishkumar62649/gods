...
export const EXPLORER_V2_ROOT = path.resolve(__dirname, '..', '..', '..');
export const DATA_RAW_ROOT = path.join(EXPLORER_V2_ROOT, 'data_raw');
export const DATA_PROCESSED_ROOT = path.join(EXPLORER_V2_ROOT, 'data_processed');
export const REFERENCE_DATA_ROOT = path.join(DATA_RAW_ROOT, 'reference');
export const AVIATION_REFERENCE_DATA_ROOT = path.join(REFERENCE_DATA_ROOT, 'aviation');
export const ORGANIZATION_REFERENCE_DATA_ROOT = path.join(REFERENCE_DATA_ROOT, 'organizations');
export const RUNTIME_DATA_ROOT = path.join(DATA_PROCESSED_ROOT, 'runtime');
