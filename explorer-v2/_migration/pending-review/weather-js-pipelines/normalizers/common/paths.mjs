...
export const RAW_WEATHER_ROOT = join(EXPLORER_ROOT, "data", "raw", "weather");
export const NORMALIZED_WEATHER_ROOT = join(EXPLORER_ROOT, "data", "staging", "weather", "normalized");
export const PROCESSED_WEATHER_ROOT = join(EXPLORER_ROOT, "data", "staging", "weather", "processed");
