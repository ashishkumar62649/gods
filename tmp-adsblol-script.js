...
function webglAddLayer() {
    ...
    let spriteSrc = spritesDataURL ? spritesDataURL : 'images/sprites_193a0304570bcce84c40d8bd51c6397b.png';
...
function displayPhoto() {
    ...
    jQuery('#copyrightInfo').html("<span>Image Â© " + copyright +"</span>");
    setPhotoHtml(new_html);
    adjustInfoBlock();
}
...
function refreshSelected() {
    ...
    if (oat != null)
        jQuery('#selected_temp').updateText(Math.round(tat) + ' / ' + Math.round(oat)  + ' Â°C');
    else
...
(function (global, jQuery, TAR) {
    ...
    cols.wd = {
        ...
        value: function(plane) { return plane.wd != null ? (plane.wd + 'Â°') : ''; },
        align: 'right' };
    cols.ws = {
        text: 'Wind S.',
...
function setSelectedIcao() {
    ...
    let hex_html = "<span style='font-family: 'B612 Mono', monospace;' class=identSmall>Hex:" + NBSP + selected.icao.toUpperCase() + "</span>";
